...
public class Restaurant implements Screen{
	...
	public Restaurant(LoveGame game) {
		this.game = game;
	...
	public void render(float delta) {
		...
		game.font.draw(game.batch, "Restaurant", Gdx.graphics.getWidth()/2 -50, Gdx.graphics.getHeight()/2+50);
